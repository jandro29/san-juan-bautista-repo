...
// src/app/views/registros-tablas/estudiantes/estudiantes.component.ts
function EstudiantesComponent_mat_error_20_Template(rf, ctx) {
  if (rf & 1) {
...
function EstudiantesComponent_mat_error_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
    \u0275\u0275text(1, " El DNI debe tener exactamente 8 n\xFAmeros ");
    \u0275\u0275elementEnd();
  }
}
...
var EstudiantesComponent = class _EstudiantesComponent {
  fb;
  form;
  constructor(fb) {
    this.fb = fb;
  ...
  onSubmit() {
    return __async(this, null, function* () {
      ...
      if (this.form.valid) {
        ...
        const { error } = yield supabase.from("estudiantes").insert([formData]);
        if (error) {
          alert("Error al registrar: " + error.message);
        } else {
          alert("Estudiante registrado con \xE9xito!!!");
          this.form.reset();
        }
      }
    });
  ...
  static \u0275fac = function EstudiantesComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _EstudiantesComponent)(\u0275\u0275directiveInject(FormBuilder));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EstudiantesComponent, selectors: [["app-estudiantes"]], decls: 39, vars: 6, consts: [["picker", ""], [1, "flex", "justify-center", "text-[30px]", "mt-[2rem]"], [1, "grid", "gap-4", "mt-[1rem]", 3, "ngSubmit", "formGroup"], [1, "flex", "justify-center"], [1, "w-[80%]", "flex", "flex-col"], [1, "flex", "flex-row", "w-[100%]"], [1, "flex", "flex-col", "w-[100%]"], ["appearance", "outline", 1, "w-[95%]", "mr-[2rem]"], ["matInput", "", "formControlName", "nombre", "required", ""], ["appearance", "outline", 1, "w-[100%]"], ["matInput", "", "formControlName", "apellidos", "required", ""], ["appearance", "outline"], ["matInput", "", "type", "text", "maxlength", "8", "formControlName", "dni", "required", "", 3, "keypress", "blur"], [4, "ngIf"], ["matInput", "", "formControlName", "fecha_nacimiento", "required", "", 3, "matDatepicker"], ["matSuffix", "", 3, "for"], ["matInput", "", "formControlName", "grado"], ["matInput", "", "formControlName", "apoderado"], ["mat-raised-button", "", "color", "primary", "type", "submit", 3, "disabled"]], template: function EstudiantesComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275elementStart(0, "h2", 1);
      \u0275\u0275text(1, "Registrar Estudiante");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(2, "form", 2);
      \u0275\u0275listener("ngSubmit", function EstudiantesComponent_Template_form_ngSubmit_2_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onSubmit());
      });
      \u0275\u0275elementStart(3, "div", 3)(4, "div", 4)(5, "div", 5)(6, "div", 6)(7, "mat-label");
      \u0275\u0275text(8, "Nombre");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(9, "mat-form-field", 7);
      \u0275\u0275element(10, "input", 8);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(11, "div", 6)(12, "mat-label");
      \u0275\u0275text(13, "Apellido");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(14, "mat-form-field", 9);
      ...
      \u0275\u0275listener("keypress", function EstudiantesComponent_Template_input_keypress_19_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.soloNumeros($event));
      })("blur", function EstudiantesComponent_Template_input_blur_19_listener() {
        let tmp_2_0;
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView((tmp_2_0 = ctx.form.get("dni")) == null ? null : tmp_2_0.markAsTouched());
      });
      \u0275\u0275elementEnd();
      \u0275\u0275template(20, EstudiantesComponent_mat_error_20_Template, 2, 0, "mat-error", 13)(21, EstudiantesComponent_mat_error_21_Template, 2, 0, "mat-error", 13);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(22, "mat-label");
      \u0275\u0275text(23, "Fecha de nacimiento");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(24, "mat-form-field", 11);
      \u0275\u0275element(25, "input", 14)(26, "mat-datepicker-toggle", 15)(27, "mat-datepicker", null, 0);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(34, "Apoderado");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(35, "mat-form-field", 11);
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(18);
      \u0275\u0275property("ngIf", ((tmp_2_0 = ctx.form.get("dni")) == null ? null : tmp_2_0.touched) && ((tmp_2_0 = ctx.form.get("dni")) == null ? null : tmp_2_0.hasError("required")));
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ((tmp_3_0 = ctx.form.get("dni")) == null ? null : tmp_3_0.touched) && ((tmp_3_0 = ctx.form.get("dni")) == null ? null : tmp_3_0.hasError("pattern")));
      \u0275\u0275advance(4);
      \u0275\u0275property("matDatepicker", picker_r2);
      \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(EstudiantesComponent, [{
    type: Component,
    args: [{ selector: "app-estudiantes", standalone: true, imports: [
      ReactiveFormsModule,
      MatFormFieldModule,
      MatInputModule,
      MatDatepickerModule,
      MatNativeDateModule,
      MatButtonModule
    ], template: `<h2 class="flex justify-center text-[30px] mt-[2rem]">Registrar Estudiante</h2>\r
\r
<form [formGroup]="form" (ngSubmit)="onSubmit()" class=" grid gap-4 mt-[1rem]">\r
    <div class="flex justify-center ">\r
        <div class="w-[80%] flex flex-col">\r
            <div class="flex flex-row w-[100%]">\r
                <div class="flex flex-col w-[100%]">\r
                    <mat-label>Nombre</mat-label>\r
                    <mat-form-field appearance="outline" class="w-[95%] mr-[2rem]">\r
\r
                        <input matInput formControlName="nombre" required />\r
                    </mat-form-field>\r
                </div>\r
                <div class="flex flex-col w-[100%]">\r
...
\r
                        <input matInput formControlName="apellidos" required />\r
                    </mat-form-field>\r
                </div>\r
            </div>\r
            <mat-label>DNI</mat-label>\r
            <mat-form-field appearance="outline">\r
                <input matInput type="text" maxlength="8" formControlName="dni" required\r
                    (keypress)="soloNumeros($event)" (blur)="form.get('dni')?.markAsTouched()" />\r
\r
                <mat-error *ngIf="form.get('dni')?.touched && form.get('dni')?.hasError('required')">\r
                    El DNI es obligatorio\r
                </mat-error>\r
\r
                <mat-error *ngIf="form.get('dni')?.touched && form.get('dni')?.hasError('pattern')">\r
                    El DNI debe tener exactamente 8 n\xFAmeros\r
                </mat-error>\r
            </mat-form-field>\r
\r
            <mat-label>Fecha de nacimiento</mat-label>\r
            <mat-form-field appearance="outline">\r
\r
                <input matInput [matDatepicker]="picker" formControlName="fecha_nacimiento" required />\r
                <mat-datepicker-toggle matSuffix [for]="picker"></mat-datepicker-toggle>\r
                <mat-datepicker #picker></mat-datepicker>\r
            </mat-form-field>\r
            <mat-label>Grado</mat-label>\r
            <mat-form-field appearance="outline">\r
\r
                <input matInput formControlName="grado" />\r
            </mat-form-field>\r
            <mat-label>Apoderado</mat-label>\r
            <mat-form-field appearance="outline">\r
\r
                <input matInput formControlName="apoderado" />\r
            </mat-form-field>\r
\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EstudiantesComponent, { className: "EstudiantesComponent", filePath: "src/app/views/registros-tablas/estudiantes/estudiantes.component.ts", lineNumber: 28 });
})();
export {
  EstudiantesComponent
};
//# sourceMappingURL=chunk-CSOQ62T3.js.map

...
var _c02 = (a0) => ({ "border border-red-500": a0 });
...
function LoginComponent_mat_error_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
    \u0275\u0275text(1, " Debe ingresar un correo v\xE1lido ");
    \u0275\u0275elementEnd();
  }
}
function LoginComponent_mat_error_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
    \u0275\u0275text(1, " El correo debe contener el car\xE1cter @ ");
    \u0275\u0275elementEnd();
  }
}
...
var LoginComponent = class _LoginComponent {
  ...
  emailDebeContenerArrobaValidator(control) {
  ...
  static \u0275fac = function LoginComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _LoginComponent)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(HttpClient), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(MatSnackBar));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginComponent, selectors: [["app-login"]], decls: 40, vars: 15, consts: [[1, "w-full", "h-screen"], [1, "flex", "columns-2", "h-screen", "h-full"], [1, "w-[50%]", "h-screen", "bg-white", "flex", "items-center", "justify-center"], ["src", \u0275\u0275trustConstantResourceUrl`https://lottie.host/embed/ee7b8b6a-b6fd-493b-96a3-4537050dbcc4/FWKx5648dO.lottie`, 1, "w-[600px]", "h-[600px]"], [1, "w-[50%]", "h-screen", "bg-[#EBEFF5]", "h-full", "flex", "justify-center", "items-center"], [1, "flex", "grid", "grid-cols-1"], [1, "flex", "justify-center"], [1, "text-[30px]", "font-bold", "text-[#302C54]"], [1, "w-[400px]", "bg-white", "h-[450px]", "m-0", "rounded-lg", "mt-[50px]"], [1, "w-full", "h-[80px]", "bg-[#302C54]", "flex", "items-center", "grid", "grid-cols-1", "rounded-tl-lg", "rounded-tr-lg"], [1, "flex", "justify-center", "items-center", "text-white", "w-full", "text-center"], ["novalidate", "", 1, "mt-[10px]", 3, "ngSubmit", "formGroup"], [1, "m-[30px]"], [1, "text-xl", "text-gray-600/75", "font-semibold"], [1, "w-[100%]"], ["type", "email", "matInput", "", "formControlName", "email", 3, "errorStateMatcher", "ngClass"], [4, "ngIf"], [1, "m-[30px]", "mt-[-1px]"], ["matInput", "", "formControlName", "password", 3, "type", "ngClass"], ["type", "button", "mat-icon-button", "", "matSuffix", "", 3, "click"], [1, "m-[30px]", "mt-[-21px]"], [1, "example-button-row", "w-[100%]"], ["type", "submit", "mat-raised-button", "", "color", "primary", 2, "width", "100%", "background", "#302C54", "color", "white"], [1, "mt-[10px]"], ["href", "/registrate", 1, "text-[#302C54]"]], template: function LoginComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div", 2);
      \u0275\u0275element(3, "iframe", 3);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "div", 4)(5, "div", 5)(6, "div", 6)(7, "h4", 7);
      \u0275\u0275text(8, "Pantalla de Login");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(9, "div", 8)(10, "div", 9)(11, "p", 10);
      \u0275\u0275text(12, " ESCUELA SAN JUAN BAUTISTA ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(13, "p", 10);
      \u0275\u0275text(14, " Sistema de Control de Pagos ");
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275text(18, "Usuario");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(19, "mat-form-field", 14);
      \u0275\u0275element(20, "input", 15);
      \u0275\u0275template(21, LoginComponent_mat_error_21_Template, 2, 0, "mat-error", 16)(22, LoginComponent_mat_error_22_Template, 2, 0, "mat-error", 16)(23, LoginComponent_mat_error_23_Template, 2, 0, "mat-error", 16);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(24, "div", 17)(25, "p", 13);
      \u0275\u0275text(26, "Contrase\xF1a");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(27, "mat-form-field", 14);
      \u0275\u0275element(28, "input", 18);
      \u0275\u0275elementStart(29, "button", 19);
      \u0275\u0275listener("click", function LoginComponent_Template_button_click_29_listener($event) {
        return ctx.clickEvent($event);
      });
      \u0275\u0275elementStart(30, "mat-icon");
      \u0275\u0275text(31);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(32, "div", 20)(33, "section")(34, "div", 21)(35, "button", 22);
      \u0275\u0275text(36, " INGRESAR AL SISTEMA ");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(37, "div", 23)(38, "a", 24);
      \u0275\u0275text(39, "Registrate");
      \u0275\u0275elementEnd()()()()()()()()();
    }
    if (rf & 2) {
      let tmp_2_0;
      ...
      \u0275\u0275advance(5);
      \u0275\u0275property("errorStateMatcher", ctx.matcher)("ngClass", \u0275\u0275pureFunction1(11, _c02, ((tmp_2_0 = ctx.loginForm.get("email")) == null ? null : tmp_2_0.invalid) && ((tmp_2_0 = ctx.loginForm.get("email")) == null ? null : tmp_2_0.touched)));
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", (tmp_3_0 = ctx.loginForm.get("email")) == null ? null : tmp_3_0.hasError("required"));
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", (tmp_4_0 = ctx.loginForm.get("email")) == null ? null : tmp_4_0.hasError("email"));
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", (tmp_5_0 = ctx.loginForm.get("email")) == null ? null : tmp_5_0.hasError("sinArroba"));
      \u0275\u0275advance(5);
      \u0275\u0275property("type", ctx.hide() ? "password" : "text")("ngClass", \u0275\u0275pureFunction1(13, _c02, ((tmp_7_0 = ctx.loginForm.get("password")) == null ? null : tmp_7_0.invalid) && ((tmp_7_0 = ctx.loginForm.get("password")) == null ? null : tmp_7_0.touched)));
      \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(LoginComponent, [{
    ...
    args: [{ selector: "app-login", standalone: true, imports: [
      ...
      RouterModule,
      MatSnackBarModule
    ], template: `<div class="w-full h-screen">\r
  <div class="flex columns-2 h-screen h-full">\r
\r
    <!-- LOTTIFY -->\r
    <div class="w-[50%] h-screen bg-white flex items-center justify-center">\r
      <iframe class="w-[600px] h-[600px]"\r
        src="https://lottie.host/embed/ee7b8b6a-b6fd-493b-96a3-4537050dbcc4/FWKx5648dO.lottie"></iframe>\r
    </div>\r
\r
    <!-- FORMULARIO -->\r
    <div class="w-[50%] h-screen bg-[#EBEFF5] h-full flex justify-center items-center">\r
      <div class="flex grid grid-cols-1">\r
        <div class="flex justify-center">\r
          <h4 class="text-[30px] font-bold text-[#302C54]">Pantalla de Login</h4>\r
        </div>\r
\r
        <div class="w-[400px] bg-white h-[450px] m-0 rounded-lg mt-[50px]">\r
\r
          <div class="w-full h-[80px] bg-[#302C54] flex items-center grid grid-cols-1 rounded-tl-lg rounded-tr-lg">\r
            <p class="flex justify-center items-center text-white w-full text-center">\r
              ESCUELA SAN JUAN BAUTISTA\r
            </p>\r
            <p class="flex justify-center items-center text-white w-full text-center">\r
              Sistema de Control de Pagos\r
            </p>\r
          </div>\r
\r
          <!-- FORM -->\r
          <form [formGroup]="loginForm" (ngSubmit)="onSubmit()" novalidate class="mt-[10px]">\r
\r
            <!-- Email -->\r
            <div class="m-[30px]">\r
              <p class="text-xl text-gray-600/75 font-semibold">Usuario</p>\r
              <mat-form-field class="w-[100%]">\r
                <input type="email" matInput formControlName="email" [errorStateMatcher]="matcher" [ngClass]="{\r
    'border border-red-500': loginForm.get('email')?.invalid && loginForm.get('email')?.touched\r
  }" />\r
                <mat-error *ngIf="loginForm.get('email')?.hasError('required')">\r
                  El correo es obligatorio\r
                </mat-error>\r
                <mat-error *ngIf="loginForm.get('email')?.hasError('email')">\r
                  Debe ingresar un correo v\xE1lido\r
                </mat-error>\r
                <mat-error *ngIf="loginForm.get('email')?.hasError('sinArroba')">\r
                  El correo debe contener el car\xE1cter &#64;\r
                </mat-error>\r
              </mat-form-field>\r
            </div>\r
\r
            <!-- Contrase\xF1a -->\r
            <div class="m-[30px] mt-[-1px]">\r
              <p class="text-xl text-gray-600/75 font-semibold">Contrase\xF1a</p>\r
              <mat-form-field class="w-[100%]">\r
                <input matInput [type]="hide() ? 'password' : 'text'" formControlName="password" [ngClass]="{\r
                  'border border-red-500': loginForm.get('password')?.invalid && loginForm.get('password')?.touched\r
                }" />\r
                <button type="button" mat-icon-button matSuffix (click)="clickEvent($event)"\r
                  [attr.aria-label]="'Hide password'" [attr.aria-pressed]="hide()">\r
                  <mat-icon>{{ hide() ? 'visibility_off' : 'visibility' }}</mat-icon>\r
                </button>\r
\r
\r
              </mat-form-field>\r
...
\r
            <!-- Bot\xF3n -->\r
            <div class="m-[30px] mt-[-21px]">\r
              <section>\r
                <div class="example-button-row w-[100%]">\r
                  <button type="submit" mat-raised-button color="primary"\r
                    style="width: 100%; background: #302C54; color: white;">\r
                    INGRESAR AL SISTEMA\r
                  </button>\r
                </div>\r
              </section>\r
\r
              <div class="mt-[10px]">\r
                <a href="/registrate" class="text-[#302C54]">Registrate</a>\r
              </div>\r
            </div>\r
\r
          </form>\r
...
</div>`, styles: ["/* src/app/views/login/login.component.css */\n.snackbar-success {\n  background-color: #4caf50;\n  color: #fff;\n}\n.snackbar-error {\n  background-color: #f44336;\n  color: #fff;\n}\n/*# sourceMappingURL=login.component.css.map */\n"] }]
  }], () => [{ type: FormBuilder }, { type: HttpClient }, { type: Router }, { type: MatSnackBar }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LoginComponent, { className: "LoginComponent", filePath: "src/app/views/login/login.component.ts", lineNumber: 49 });
})();
export {
  LoginComponent,
  MyErrorStateMatcher
};
//# sourceMappingURL=chunk-7MVLYTAD.mjs.map
